                ...
                <div class="col-sm-6 col-xs-8">
                    <div class="social">
                        <ul class="social-share">
                            ...
                            <li>
                                <a href="javascript:void(0)" onclick="document.getElementById('light').style.display='block';document.getElementById('fade').style.display='block'"><i class="fa fa-qq">qq</i></a>
                            </li>
                            <li>
                                <a target="_blank" href="http://weibo.com/1801439974/profile?topnav=1&wvr=6&is_all=1"><i class="fa fa-weibo"></i></a>
                            </li>
                            <li>
                                <a href="javascript:void(0)" onclick="document.getElementById('light').style.display='block';document.getElementById('fade').style.display='block'"><i class="fa fa-weixin fa-4" aria-hidden="true">weixin</i></a>
                            </li>
                            <li>
                                <a href="javascript:void(0)" onclick="document.getElementById('light').style.display='block';document.getElementById('fade').style.display='block'"><i class="fa fa-">支</i></a>
                            </li>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="widget">
                    ...
                    <ul>
                        ...
                        <li>
                            <a target="_blank" href="http://mail.qq.com/cgi-bin/qm_share?t=qm_mailme&email=ne7p6Pn08t3o--z5--z5s-7_" style="text-decoration:none;"><img src="http://rescdn.qqmail.com/zh_CN/htmledition/images/function/qm_open/ico_mailme_11.png"/></a>
                        </li>
                        <li>
                ...
                <div class="widget">
                    ...
                    <ul>
                        ...
                        <script type="text/javascript">var cnzz_protocol = (("https:" == document.location.protocol) ? " https://" : " http://");
                            document.write(unescape("%3Cspan id='cnzz_stat_icon_1262125724'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s19.cnzz.com/z_stat.php%3Fid%3D1262125724%26show%3Dpic' type='text/javascript'%3E%3C/script%3E"));</script>
                    </ul>
                </div>
            </div><!--/.col-md-3-->
...
<footer id="footer" class="midnight-blue">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                &copy; 2014-<?= date('Y') ?>
                <a target="_blank" href="http://ubadbad.cc/" title="Learn with Mr.wei">Ubadbad.cc</a>. All Rights Reserved.
            </div>
            <div class="col-sm-6">
                <ul class="pull-right">
                    <li><a href="#">Home</a></li>
