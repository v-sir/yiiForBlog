 ...
 *
 *  * `appPath` - full path to the application, include index_.php</li>
 *  * `url` - full url to the index_.php entry script</li>
 *
 * In your index_.php you must return an array with correct configuration for the application:
 *
 * For the simple created yii application index_.php will be like this:
 *
 * ```php
 * <?php
 ...
 *     enabled:
 *         - Yii1:
 *             appPath: '/path/to/index_.php'
 *             url: 'http://localhost/path/to/index_.php'
 *         - \Helper\Functional
 * ```
 *
